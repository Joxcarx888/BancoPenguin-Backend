...
import { validateLogin } from '../middlewares/validate-auth.js';
import { validateRegisterUser } from '../middlewares/validate-auth.js';
...
export const login = async (req, res) => {
    ...
    try {
      ...
      // Si es CLIENTE, también validar código de banco
      if (user.role === "CLIENT") {
